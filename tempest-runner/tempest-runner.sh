...
export ADMIN_ROLE_NAME=${ADMIN_ROLE_NAME:-admin}
...
pushd $TOP_DIR/../..
    ...
    pushd $TEMPEST_DIR
        ...
        if [ "$CREATE_ENTITIES" = "true" ]; then
            ...
            user_role_add $TOS__IDENTITY__ADMIN_USERNAME $TOS__IDENTITY__TENANT_NAME $MEMBER_ROLE_NAME
            user_role_add $TOS__IDENTITY__ADMIN_USERNAME $TOS__IDENTITY__TENANT_NAME $ADMIN_ROLE_NAME
            ...
            user_role_add $TOS__IDENTITY__ADMIN_USERNAME $TOS__IDENTITY__ALT_TENANT_NAME $MEMBER_ROLE_NAME
            user_role_add $TOS__IDENTITY__ADMIN_USERNAME $TOS__IDENTITY__ALT_TENANT_NAME $ADMIN_ROLE_NAME
